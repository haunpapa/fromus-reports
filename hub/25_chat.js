...
const CG_INIT = { strategy:6, actions:8, news:6, readings:6 };
const CG_SECS = [
...
const CG_RENDERERS = { strategy:cgStrategyRow, actions:cgActionRow, news:cgNewsRow, readings:cgReadingRow };
